...
parser.add_argument("--PRIMER5_START", default="1")
parser.add_argument("--PRIMER5_END", default="500")
parser.add_argument("--PRIMER3_START", default="600")
parser.add_argument("--PRIMER3_END", default="1000")
parser.add_argument("--PRIMER_PRODUCT_MIN", default="500")
parser.add_argument("--PRIMER_PRODUCT_MAX", default="800")
