...
if args.PRIMER5_START is not None:
  url_1 += '&PRIMER5_START=' + args.PRIMER5_START
if args.PRIMER5_END is not None:
  url_1 += '&PRIMER5_END=' + args.PRIMER5_END
if args.PRIMER3_START is not None:
  url_1 += '&PRIMER3_START=' + args.PRIMER3_START
if args.PRIMER3_END is not None:
  url_1 += '&PRIMER3_END=' + args.PRIMER3_END
if args.PRIMER_PRODUCT_MIN is not None:
  url_1 += '&PRIMER_PRODUCT_MIN=' + args.PRIMER_PRODUCT_MIN
if args.PRIMER_PRODUCT_MAX is not None:
  url_1 += '&PRIMER_PRODUCT_MAX=' + args.PRIMER_PRODUCT_MAX
